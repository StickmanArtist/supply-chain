    ...
    <div style={{ flex:1, position:'relative', overflow:'hidden', background:'#D6EAF5' }}>
      ...
      >
        <defs>
          ...
          <style>{`.ta{stroke-dasharray:5 4;animation:da 1.4s linear infinite}@keyframes da{to{stroke-dashoffset:-18}}`}</style>
        </defs>
          ...
          {countries.map(f => {
            ...
            return (
              <path key={f.id} d={pathGen(f)}
                ...
                stroke="white" strokeWidth={0.5 / transform.k}
                opacity={isDim ? 0.3 : 1}
          ...
          <g key={partnerName}>
            ...
            {!isInRegions && (
              <>
                ...
                />
                <text x={labelX} y={labelY+2*strokeScale}
                  textAnchor="middle"
